    ...
    public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.ViewHolder> implements Filterable {
        ...
        public void toggleSelection(int pos, ImageView img) {
            ...
            if (selectedItems.get(pos, false)) {
                ...
                Picasso.with(getActivity()).load(R.drawable.purchase).placeholder(R.drawable.purchase).into(img);

            } else {
                selectedItems.put(pos, true);
                if (mActionMode != null)
                    Picasso.with(getActivity()).load(R.drawable.checked).placeholder(R.drawable.purchase).into(img);
